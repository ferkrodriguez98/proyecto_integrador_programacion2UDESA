window.onload = function functionName() {
	...
	var detalleURL =
		"https://api.themoviedb.org/3/tv/" + serieId + "?api_key=" + key;
	...
	// TRAILER
	var trailerULR =
		"https://api.themoviedb.org/3/tv/" + serieId + "/videos?api_key=" + key;
